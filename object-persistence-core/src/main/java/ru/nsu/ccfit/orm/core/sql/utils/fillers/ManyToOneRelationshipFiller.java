...
public class ManyToOneRelationshipFiller implements ObjectFiller {
    ...
    public void fillObject(TableMetaData tableMetaData, Object instance, List<String> columnsList, ResultSet rs)
        ...
        for (String complexRow : tableMetaData.manyToOneRowsData().keySet()) {
            FieldInfo fieldInfo = tableMetaData.manyToOneRowsData().get(complexRow);
